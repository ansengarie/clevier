        ...
        <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
          <div class="right mx-lg-0 mx-auto">
            ...
            <form style="margin-top: 1.5rem" action="" class="/login" method="post">
              <div style="margin-bottom: 1.75rem">
                ...
                <div class="d-flex w-100 div-input">
                  ...
                  @csrf
                  <input class="input-field border-0" type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email"  placeholder="Your Email Address" required value="{{ old('email') }}" autofocus />
                    @error('email')
              ...
              <div style="margin-top: 1rem">
                ...
                <div class="d-flex w-100 div-input">
                  ...
                  <input class="input-field border-0" type="password"  name="password" class="form-control" id="password" placeholder="Your Password" required/>
            ...
            <p class="text-center bottom-caption">
              ...
              <a href="/register#scroll-register" class="green-bottom-caption">Register Here</a>
            </p>
          </div>
        </div>
      </div>

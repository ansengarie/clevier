          ...
          <form style="margin-top: 1.5rem" action="" class="/login" method="post">
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                @csrf
                <input class="input-field border-0" type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email"  placeholder="Your Email Address" required value="{{ old('email') }}" required />
                  @error('email')

    ...
    <div class="container-xxl mx-auto p-0  position-relative header-2-2">
        ...
        <div>
          <div class="mx-auto d-flex flex-lg-row flex-column hero">
            ...
            <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center pt-5">
              ...
              <p class="text-caption-about"><span style="color:#00b4b4;">Innerior</span> is a website that can make it <br> easier to find the best recommendations furniture for for you</p>
      ...
      <div class="content-2-2 container-xxl mx-auto p-0  position-relative">
        ...
        <div class="card-block">
          ...
          <!--- Team --->
          <div class="text-center title-text">
            <h1 class="story-aboutus mb-5">Our Team</h1>
          </div>
          <div class="row mb-5">
            ...
            <div class="col-lg-3 d-flex flex-column align-items-center text-center">
              <img class="bd-placeholder-img rounded-circle mb-2" width="150" src="/img/team/salsa.png">
          ...
          <div class="row mt-5">
              ...
              <div class="col-md-5">
                <h1 class="story-aboutus text-center mb-3">Contact Us</h1>
                ...
                <div class="col-md-6 mt-2">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1978.5855106018976!2d24.876030815692566!3d60.27031284226152!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x468df7a32a7badb1%3A0xaab224ac557aae0b!2sTesla%20Store%20Helsinki-Vantaa!5e0!3m2!1sen!2sid!4v1576821767135!5m2!1sen!2sid" width="520" height="430"frameborder="0" style="border:0; border-radius:10px;" allowfullscreen=""></iframe>
                </div>
              </div>
          </div>
      </div>

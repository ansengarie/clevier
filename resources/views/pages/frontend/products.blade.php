        ...
        <div class="carousel-item active overflow-hidden shadow p-3 bg-body">
          ...
          <div class="container">
            <div class="carousel-caption justify-content-left my-5">
              ...
              <a class="btn mt-4" style="margin-bottom: -15px; padding-bottom: 15px; padding-top: 15px;" href="#products">Let's Explore!</a>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group mx-auto">
                  <a href="/details/{{ $product->slug }}"class="link btn btn-fill text-white" style="margin-top: 20px; border-radius: 0.75em;"><button type="button" class="btn btn-sm" style="font-size: 16px;"><button type="button" class="btn btn-sm">View</button></a>
                </div>
              </div>
            </div>
          </div>
